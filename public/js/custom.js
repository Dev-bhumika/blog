$(function() {
    ...
    $("#val_password_setup, #val_activation_by_email").change(function(){
        var option = $("#val_password_setup").val(); 
        var email = $("#val_activation_by_email").val();      
    ...
    $(".deleterow").click(function(){   
        ...
        if(action == 'users'){
            ...
            var url = "hotspots/delete/"+id
        } else if(action == 'zones'){
            var url = "zones/delete/"+id
        } else if(action == 'smstemplate'){
            var url = "smstemplate/delete/"+id
        } else if(action == 'smsprofile'){
            var url = "smsprofile/delete/"+id
        }  else if(action == 'plans'){
            var url = "plans/delete/"+id
        }
    ...
    $(document).ready(function() {
        ...
        $(".toggle-password").click(function() {            
            $(this).find('i').toggleClass("icon-eye2 icon-eye-blocked2");
    ...
    function sameAsAbove()
    {
        if($('#custom_checkbox_stacked_unchecked').is(":checked"))   {
            $('#custom_checkbox_stacked_unchecked').val(1);
            $(".admin-group").slideUp('slow');
        } else {
            $('#custom_checkbox_stacked_unchecked').val(2);
            $(".admin-group").slideDown('slow');
        }
    }
